...
const UNITS = [
  { id: '1', title: 'Unit – I : General Science', icon: '🔬' },
  { id: '2', title: 'Unit – II : Current Events', icon: '📰' },
  { id: '3', title: 'Unit – III : Geography', icon: '🌍' },
  { id: '4', title: 'Unit – IV : History & Culture', icon: '🏛️' },
  { id: '5', title: 'Unit – V : Indian Polity', icon: '⚖️' },
  { id: '6', title: 'Unit – VI : Indian Economy', icon: '📊' },
  { id: '7', title: 'Unit – VII : Indian National Movement', icon: '🇮🇳' },
  { id: '8', title: 'Unit – VIII : Aptitude & Mental Ability', icon: '🧠' },
];
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <ThemedText style={[styles.headerTitle, { color: colors.text }]}>Outside Source</ThemedText>
        <View style={styles.placeholder} />
      </View>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={[styles.infoCard, { backgroundColor: colors.card }]}>
          <ThemedText style={[styles.infoTitle, { color: colors.text }]}>Units</ThemedText>
          <ThemedText style={[styles.infoSubtitle, { color: colors.textSecondary }]}>Select a unit to study</ThemedText>
        </View>
