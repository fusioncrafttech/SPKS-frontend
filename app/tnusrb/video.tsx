...
const VIDEO_CATEGORIES = [
  { id: 'tamil-grammar', title: 'Tamil - Part A (Grammar)', icon: '📖' },
  { id: 'tamil-literature', title: 'Tamil - Part B (Literature)', icon: '📚' },
  { id: 'tamil-scholars', title: 'Tamil - Part C (Scholars & Contribution)', icon: '👨‍🏫' },
  { id: 'gk-part-a', title: 'General Knowledge - Part A', icon: '📰' },
  { id: 'gk-part-b', title: 'General Knowledge - Part B', icon: '🌍' },
];
...
export default function VideoScreen() {
  ...
  const handleVideoPress = (id: string, title: string) => {
    results.show(title, () => loadCourseItems('tnusrb', 'videos', { category: id, search: title }));
  };
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={[styles.infoCard, { backgroundColor: colors.card }]}>
          <ThemedText style={[styles.infoTitle, { color: colors.text }]}>TNUSRB Video Explanations</ThemedText>
          <ThemedText style={[styles.infoSubtitle, { color: colors.textSecondary }]}>Direct Connect YouTube - Complete syllabus coverage</ThemedText>
        </View>
        ...
        <View style={styles.youtubeBanner}>
          ...
          <View style={styles.youtubeContent}>
            ...
            <ThemedText style={[styles.youtubeSubtitle, { color: colors.textSecondary }]}>Expert video tutorials for TNUSRB exams</ThemedText>
          </View>
        </View>

        <View style={styles.sectionHeader}>
          <ThemedText style={[styles.sectionTitle, { color: colors.text }]}>Select Subject</ThemedText>
        </View>
