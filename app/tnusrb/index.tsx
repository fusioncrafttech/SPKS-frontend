...
export default function TNUSRBScreen() {
  ...
  const menuItems = [
    { id: 'notes', title: 'Notes', subtitle: 'Tamil (Parts A, B, C) & GK (Parts A, B)', icon: '📚', route: '/tnusrb/notes' },
    { id: 'test', title: 'Test', subtitle: 'SI & PC - Topic-wise and Full Tests', icon: '📝', route: '/tnusrb/test' },
    { id: 'video', title: 'Video Explain', subtitle: 'Direct Connect YouTube', icon: '🎥', route: '/tnusrb/video' },
  ];
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <ThemedText style={[styles.headerTitle, { color: colors.text }]}>TNUSRB</ThemedText>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.infoBanner, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.bannerContent}>
            <ThemedText style={[styles.bannerTitle, { color: colors.text }]}>Tamil Nadu Uniformed Services Recruitment Board</ThemedText>
            <ThemedText style={[styles.bannerSubtitle, { color: colors.textSecondary }]}>Police Recruitment - Notes, Test & Video Explanations</ThemedText>
          </View>
        </View>
