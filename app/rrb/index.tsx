...
export default function RRBScreen() {
  ...
  const menuItems = [
    { id: 'notes', title: 'Notes', subtitle: 'Mathematics, Reasoning, General Awareness & more', icon: '📚', route: '/rrb/notes' },
    { id: 'test', title: 'Test', subtitle: 'Group D, NTPC, JE, ALP - CBT 1 & 2', icon: '📝', route: '/rrb/test' },
    { id: 'video', title: 'Video Explain', subtitle: 'Direct Connect YouTube', icon: '🎥', route: '/rrb/video' },
  ];
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <ThemedText style={[styles.headerTitle, { color: colors.text }]}>RRB</ThemedText>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.infoBanner, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.bannerContent}>
            <ThemedText style={[styles.bannerTitle, { color: colors.text }]}>Railway Recruitment Board</ThemedText>
            <ThemedText style={[styles.bannerSubtitle, { color: colors.textSecondary }]}>Notes, Test & Video Explanations</ThemedText>
          </View>
        </View>
